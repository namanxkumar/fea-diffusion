...
parser.add_argument('--data_dir', type=str, default='data/feadata2500', help='Data directory.')
parser.add_argument('--sample_data_dir', type=str, default='data/sample_1', help='Sample data directory.')
