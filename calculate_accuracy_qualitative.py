from metrics.calculate_accuracy_qualitative import calculate_accuracy
from metrics.calculate_accuracy_qualitative import calculate_accuracy_per_step
import argparse
import numpy as np
...
MAE, MSE, RMSE, SSIM, mean_absolute_error_values, mean_squared_error_values, root_mean_squared_error_values, ssim = calculate_accuracy_per_step(
