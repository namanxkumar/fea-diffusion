...
class ResnetSubBlock(nn.Module):
    def __init__(self, input_dim: int, output_dim: int, num_groups_for_normalization: int = 8):
        super().__init__()
...
class ResnetBlock(nn.Module):
    def __init__(self, input_dim: int, output_dim: int, *, time_embedding_dim: Optional[int] = None, num_groups_for_normalization: int = 8):
        super().__init__()
