...
class ConditionedResnetBlock(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.conditional_block1 = FeatureDenormalization(
            input_dim,
        ...
        self.conditional_block2 = FeatureDenormalization(
            output_dim,
            condition_features_dim,
            num_groups_for_normalization=num_groups_for_normalization,
        )
...
class FDNUNet(nn.Module):
    ...
    def forward(
        ...
        for index, (block_1, block_2, attention, downsample) in enumerate(
            self.down_layers
        ):
