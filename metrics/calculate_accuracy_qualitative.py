...
def calculate_accuracy(
    ...
    for index in total_samples:
        ...
        gt_x_file = ground_truth_data_path / str(plate_index) / str(condition_index) / f"outputs_displacement_x_{step_index}.png"
        gt_y_file = ground_truth_data_path / str(plate_index) / str(condition_index) / f"outputs_displacement_y_{step_index}.png"
