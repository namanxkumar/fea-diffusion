...
parser.add_argument('--num_epochs_per_milestone', type=int, default=10, help='Number of epochs per milestone.')
...
trainer = Trainer(
    ...
    num_epochs_per_milestone=args.num_epochs_per_milestone,
